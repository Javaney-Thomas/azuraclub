...
const NoProductsFound = () => {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-br  w-full">
      ...
      <p className="text-lg text-gray-400 mb-6 text-center max-w-md">
        ...
        categories or using the search bar to find what you need.
      </p>
      <Link href="/">
        <span className="bg-primaryx hover:bg-primaryx-hover text-white py-2 px-6 rounded-full transition duration-200">
          Back to Shop
        </span>
      </Link>
    </div>
